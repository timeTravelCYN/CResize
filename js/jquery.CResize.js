(function($) {
  /**
   * 优化1.0 此版本不再在初始加载页面的时候就加载全部的resize，而是点击某个的时候再加载。
   */
  ...
  CResize.prototype = {
    ...
    initResizeBox: function(thisEl) {
      ...
      // $('.' + self.options.itemClass).each(function() {
        ...
        self.appendHandler(resizePanel, thisEl);
        ...
        // 绑定拖拽缩放事件
        self.bindResizeEvent(resizePanel, thisEl);

        // 绑定触发事件
        self.bindTrigger(thisEl);
      // });
      self.triggerResize(thisEl);
